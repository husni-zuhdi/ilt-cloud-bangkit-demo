output "master_instance_name" {
  ...
  value       = module.cloud-sql.master_instance_name
}
...
output "master_ip_addresses" {
  ...
  value       = module.cloud-sql.master_ip_addresses
}

output "master_private_ip" {
  description = "The private IPv4 address of the master instance"
  value       = module.cloud-sql.master_private_ip_address
}

output "master_instance" {
  description = "Self link to the master instance"
  value       = module.cloud-sql.master_instance
}
...
output "master_proxy_connection" {
  ...
  value       = module.cloud-sql.master_proxy_connection
}
